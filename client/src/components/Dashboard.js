...
import AvgTestCard from './SharedComponents/dataCards/AvgTestCard'
import LastTestCard from './SharedComponents/dataCards/LastTestCard'
import A1cCard from './SharedComponents/dataCards/A1Ccard'
import ReferenceCard from './SharedComponents/dataCards/ReferenceCard'
...
export default function Dashboard() {
    ...
    function avgBloodS() {
        ...
        if (!testArr.length) {
            ...
            setAvgBS("No Blood Sugars Entered Yet")
    ...
    function a1Cfunct() {
        ...
        if (testArr.length < 10) {
            setA1c("Not Enough Blood Sugars entered to calculate")
